      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {WEDDING_EVENTS.map((evt, idx) => (
            ...
            >
              <div
                className="group h-full relative rounded-3xl overflow-hidden bg-white/60 backdrop-blur-xl border-2 border-white/80 shadow-[0_12px_30px_rgba(139,30,63,0.08),inset_0_0_20px_rgba(255,255,255,0.9)] hover:-translate-y-2 hover:shadow-[0_20px_45px_rgba(139,30,63,0.18)] transition-all duration-500 flex flex-col justify-between"
              >
                <div>
